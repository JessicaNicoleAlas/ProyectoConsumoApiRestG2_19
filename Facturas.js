var UrlGetFacturas = 'http://localhost:80/G2_19/controller/facturas.php?op=GetFacturas';
var UrlPostFactura = 'http://localhost:80/G2_19/controller/facturas.php?op=InsertFactura';
var UrlGetUno = 'http://localhost:80/G2_19/controller/facturas.php?op=GetUno';
var UrlPutFactura = 'http://localhost:80/G2_19/controller/facturas.php?op=UpdateFactura';
var UrlDeleteFactura = 'http://localhost:80/G2_19/controller/facturas.php?op=DeleteFactura';
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            for(i= 0; i < MiItems.length; i++){
                ...
                '<td>'+
                '<button class="btn btn-primary" onclick="CargarFactura('+MiItems[i].ID+')">Editar</button>'+
                '</td>'+
                '<td>'+
                '<button class="btn btn-outline-info" onclick="EliminarFactura('+MiItems[i].ID+')">Eliminar</button>'+
                '</td>'+
                '</tr>';
